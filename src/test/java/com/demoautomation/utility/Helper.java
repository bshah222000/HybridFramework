package com.demoautomation.utility;
...
public class Helper {
	...
	public static void waitForWebElementAndClick(WebDriver driver,By element,String stepInfo)
	{
		...
		WebElement ele=null;//=wait.until(ExpectedConditions.elementToBeClickable(element));
	...
	public static WebElement waitForWebElement(WebDriver driver,String xpath)
	{
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofSeconds(20));
		WebElement ele = null;
		return ele;//wait.until(ExpectedConditions.elementToBeClickable(By.xpath(xpath)));
	}
	
	public static void handleAlertAndVerifyPartialText(WebDriver driver,String expectedText)
	{
		Alert alt=null;//new WebDriverWait(driver, Duration.ofSeconds(20)).until(ExpectedConditions.alertIsPresent());
